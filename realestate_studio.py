...
class FooocusClient:
    ...
    def payload_text_to_image(self, prompt: str, negativo: str = "",
...
class VerticalLotes:
    ...
    def _req(self, prompt: str, aspect: str, estilos: list[str] | None = None,
    ...
    def chacra_pampeana(self, hectareas: float | int = 5,
        municipio: str = "Ca\u00f1uelas",
        epoca: str = "verano pampeano",
        momento: str = "golden hour") -> GenerationRequest:
        """Vista de chacra tradicional pampeana con casa principal al fondo."""
        base = self.plantillas.get("chacra_pampeana", "")
        desc = f"{hectareas} hectares pampas farm, traditional estancia house, {municipio}, Argentina"
        prompt = (
            f"{desc}, {epoca}, {momento}, "
            f"{base}, real estate photography"
        )
        return self._req(prompt, ASPECT_CHACRA, self.ESTILOS_CINEMATIC,
                         {"tipo": "chacra", "hectareas": hectareas,
                          "municipio": municipio})

    def country_premium(self, nombre: str = "El Casco",
        amenities: str = "golf, club house, pileta, canchas de tenis",
        momento: str = "blue hour") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_COUNTRY, self.ESTILOS_CINEMATIC,
                         {"tipo": "country", "nombre": nombre})

    def lote_periurbano(self, metros_cuadrados: int = 1000,
        municipio: str = "Pilar") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE,
                         {"tipo": "lote_periurbano", "metros": metros_cuadrados,
                          "municipio": municipio})

    def vista_aerea_loteo(self, n_lotes: int = 24,
        ...
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_AEREAS,
                         {"tipo": "aerea", "n_lotes": n_lotes,
                          "municipio": municipio})

    def loteo_en_desarrollo(self, etapa: str = "Etapa 2",
        municipio: str = "Escobar") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_FOTOS,
                         {"tipo": "loteo_obra", "etapa": etapa,
                          "municipio": municipio})

    def campo_mediano(self, hectareas: int = 50,
        rubro: str = "ganadero mixto",
        municipio: str = "Brandsen") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_CINEMATIC,
                         {"tipo": "campo", "hectareas": hectareas,
                          "rubro": rubro, "municipio": municipio})

    def campo_grande(self, hectareas: int = 300,
        rubro: str = "agricola-ganadero",
        municipio: str = "Saladillo") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_CINEMATIC,
                         {"tipo": "campo_grande", "hectareas": hectareas,
                          "rubro": rubro, "municipio": municipio})

    def lote_inversion_chico(self, metros_cuadrados: int = 600,
        municipio: str = "Pilar") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE,
                         {"tipo": "lote_chico", "metros": metros_cuadrados,
                          "municipio": municipio})

    def pileta_quinta(self, hectareas: float = 2,
        municipio: str = "Escobar") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_CINEMATIC,
                         {"tipo": "quinta", "hectareas": hectareas,
                          "municipio": municipio})

    def estancia_productiva(self, hectareas: int = 200,
        municipio: str = "San Antonio de Areco") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_CINEMATIC,
                         {"tipo": "estancia", "hectareas": hectareas,
                          "municipio": municipio})

    def emprendimiento_agroturistico(self, hectareas: int = 20,
        municipio: str = "Tandil") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_CINEMATIC,
                         {"tipo": "agroturismo", "hectareas": hectareas,
                          "municipio": municipio})

    def lote_comercial_ruta(self, metros_cuadrados: int = 2000,
        municipio: str = "Campana") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE,
                         {"tipo": "lote_comercial", "metros": metros_cuadrados,
                          "municipio": municipio})
    ...
    def amanecer_pampa(self, municipio: str = "Luj\u00e1n") -> GenerationRequest:
        ...
        prompt = (
            f"sunrise over pampas fields in {municipio}, Buenos Aires province, "
            f"{base}"
        )
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_CINEMATIC,
                         {"tipo": "amanecer", "municipio": municipio})

    def atardecer_campo(self, hectareas: float | int = 5,
        municipio: str = "Mercedes") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_VISTA_AEREA, self.ESTILOS_CINEMATIC,
                         {"tipo": "atardecer", "hectareas": hectareas,
                          "municipio": municipio})
    ...
    def tranquera_argentina(self, municipio: str = "Ca\u00f1uelas") -> GenerationRequest:
        ...
        prompt = (
            f"rustic wooden gate entrance to farm in {municipio}, Buenos Aires province, "
            f"{base}"
        )
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE, self.ESTILOS_FOTOS,
    ...
    def molino_tanque_australiano(self, municipio: str = "Roque P\u00e9rez") -> GenerationRequest:
        ...
        prompt = (
            f"classic windmill and water tank in {municipio}, Buenos Aires province, "
            f"{base}"
        )
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE, self.ESTILOS_FOTOS,
    ...
    def variaciones(self, prompt_base: str, n: int = 4) -> list[GenerationRequest]:
        ...
        return [
            GenerationRequest(prompt=prompt_base, seed=seed,
...
class VerticalConstruccion:
    ...
    def _req(self, prompt: str, aspect: str,
             estilos: list[str] | None = None,
             metadata: dict[str, Any] | None = None) -> GenerationRequest:
        return GenerationRequest(
            prompt=prompt, negative_prompt=self.negativos,
            aspect_ratio=aspect,
            styles=estilos or self.ESTILOS_FOTOS,
            metadata=metadata or {},
        )

    def movimiento_suelo(self, maquinaria: str = "retroexcavadora Komatsu",
        municipio: str = "Pilar") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE,
                         {"tipo": "movimiento_suelo", "maquinaria": maquinaria,
                          "municipio": municipio})

    def obra_gruesa(self, etapa: str = "hormig\u00f3n armado",
        municipio: str = "Escobar") -> GenerationRequest:
    ...
    def steel_framing(self, municipio: str = "Ca\u00f1uelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE,
                         {"tipo": "steel_frame", "municipio": municipio})

    def render_proyecto(self, estilo: str = "casa de campo tradicional",
                       hectareas: float = 5,
                       municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE,
                         ...
                         metadata={"tipo": "render_proyecto", "estilo": estilo,
                                   "hectareas": hectareas, "municipio": municipio})

    # ============== PRE-CONSTRUCCION ==============

    def anteproyecto_arquitectonico(self, estilo: str = "minimalista moderno",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_CINEMATIC,
                         {"tipo": "anteproyecto", "estilo": estilo,
                          "municipio": municipio})

    def render_exterior_casa(self, estilo: str = "moderna minimalista",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE,
                         estilos=self.ESTILOS_FOTOS + ["misc-architectural"],
                         metadata={"tipo": "render_exterior", "estilo": estilo,
                                   "municipio": municipio})

    def render_interior_casa(self, ambiente: str = "living",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE,
                         estilos=self.ESTILOS_FOTOS + ["misc-architectural"],
                         metadata={"tipo": "render_interior", "ambiente": ambiente,
                                   "municipio": municipio})
    ...
    def excavacion_fundaciones(self, maquinaria: str = "retroexcavadora",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_FOTOS,
                         {"tipo": "excavacion", "maquinaria": maquinaria,
                          "municipio": municipio})
    ...
    def cubierta_techo(self, tipo_techo: str = "chapa",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_FOTOS,
                         {"tipo": "cubierta", "material": tipo_techo,
                          "municipio": municipio})
    ...
    def colocacion_aberturas(self, tipo: str = "aluminio DVH",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_SQUARE, self.ESTILOS_FOTOS,
                         {"tipo": "aberturas", "material": tipo,
                          "municipio": municipio})

    def colocacion_pisos(self, tipo_piso: str = "porcelanato",
        municipio: str = "Cañuelas") -> GenerationRequest:
        """Colocacion de pisos."""
    ...
    def casa_terminada_frente(self, estilo: str = "minimalista moderno",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE,
                         ...
                         metadata={"tipo": "casa_terminada", "estilo": estilo,
                                   "municipio": municipio})
    ...
    def equipo_pesado_construccion(self, maquinaria: str = "excavadora CAT",
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_FOTOS,
                         {"tipo": "equipo_pesado", "maquinaria": maquinaria,
                          "municipio": municipio})
    ...
    def equipo_humano_obra(self, n_personas: int = 8,
        municipio: str = "Cañuelas") -> GenerationRequest:
        ...
        return self._req(prompt, ASPECT_INSTAGRAM_LANDSCAPE, self.ESTILOS_FOTOS,
                         {"tipo": "equipo_humano", "n_personas": n_personas,
                          "municipio": municipio})
...
class CaptionFactory:
    ...
    def hashtags(self, nichos: list[str] | None = None,
        ...
        must_include = [h if h.startswith("#") else f"#{h}"
                        for h in (must_include or [])]
        ...
        if blacklist:
            pool = [h for h in pool
                    if h.lstrip("#").lower() not in blacklist]
    ...
    def post_lote_venta(self, tema: str, municipio: str,
        ...
        nichos: list[str] | None = None) -> dict[str, Any]:
        nichos = nichos or ["general", "campo", "inversion"]
        caption_text = self.caption("lote_venta", tono,
                                    tema=tema, municipio=municipio,
                                    hectareas=hectareas,
                                    distancia_caba=distancia_caba,
                                    servicios_disponibles=servicios_disponibles,
                                    unidades_disponibles=unidades_disponibles)
        hashtags = self.hashtags(nichos, municipio)
        return self._armar_post(tema, "lote_venta", municipio, tono,
                                caption_text, hashtags)

    def post_country(self, nombre_country: str, municipio: str,
        ...
        tono: str = "premium") -> dict[str, Any]:
        caption_text = self.caption("country", tono,
        ...
        return self._armar_post(tema, "country", municipio, tono,
                                caption_text, hashtags)

    def post_campo(self, hectareas: str, municipio: str,
        rubro: str = "ganadero mixto",
        aptitud: str = "agr\u00edcola-ganadera",
        precio_usd: str = "8.500",
        distancia_caba: str = "120 km",
        tono: str = "inversion") -> dict[str, Any]:
        caption_text = self.caption("campo", tono,
                                    hectareas=hectareas, municipio=municipio,
                                    rubro=rubro, aptitud=aptitud,
                                    precio_usd=precio_usd,
                                    distancia_caba=distancia_caba)
        hashtags = self.hashtags(["campo", "inversion"], municipio)
        tema = f"{hectareas} en {municipio}"
        return self._armar_post(tema, "campo", municipio, tono,
                                caption_text, hashtags)

    def post_preventa(self, nombre_loteo: str, municipio: str,
        etapa: str = "2",
        metros_cuadrados: int = 1000,
        ...
        tono: str = "oportunidad") -> dict[str, Any]:
        caption_text = self.caption("preventa_loteo", tono,
                                    etapa=etapa,
        ...
        return self._armar_post(tema, "preventa_loteo", municipio, tono,
                                caption_text, hashtags)

    def post_lote_periurbano(self, municipio: str, metros_cuadrados: int = 1000,
        metros_asfalto: int = 200,
        tono: str = "practico") -> dict[str, Any]:
        caption_text = self.caption("lote_periurbano", tono,
                                    municipio=municipio,
                                    metros_cuadrados=metros_cuadrados,
                                    metros_asfalto=metros_asfalto)
        hashtags = self.hashtags(["general"], municipio)
        tema = f"Terreno en {municipio}"
        return self._armar_post(tema, "lote_periurbano", municipio, tono,
                                caption_text, hashtags)

    def post_testimonial_cliente(self, cliente: str, historia: str,
        resultado: str, tema: str = "casa en el campo",
        tiempo: str = "8 meses",
        tono: str = "emotivo",
        nichos: list[str] | None = None) -> dict[str, Any]:
        nichos = nichos or ["casas", "construccion", "general"]
        caption_text = self.caption("testimonial_cliente", tono,
                                    cliente=cliente, historia=historia,
                                    resultado=resultado, tema=tema,
                                    tiempo=tiempo)
        hashtags = self.hashtags(nichos)
        return self._armar_post(
            f"Testimonio {cliente}", "testimonial_cliente", "", tono,
            caption_text, hashtags)

    def post_preguntas_frecuentes(self, tema: str,
        ...
        hashtags = self.hashtags(nichos)
        return self._armar_post(
            f"FAQ: {tema}", "preguntas_frecuentes", "", tono,
            caption_text, hashtags)

    def post_obra_avance_semanal(self, semana: int, municipio: str,
        etapa: str, avance: int,
        tareas: list[str], proxima_etapa: str,
        tono: str = "practico",
        nichos: list[str] | None = None) -> dict[str, Any]:
        nichos = nichos or ["construccion", "casas"]
        tareas = (tareas + ["", "", ""])[:3]
        caption_text = self.caption("obra_avance_semanal", tono,
                                    semana=semana, municipio=municipio,
                                    etapa=etapa, avance=avance,
                                    tarea_1=tareas[0],
                                    tarea_2=tareas[1],
                                    tarea_3=tareas[2],
        ...
        return self._armar_post(
            ...
            "obra_avance_semanal", municipio, tono,
            caption_text, hashtags)
    ...
    def post_reel_hook(self, tema: str, tono: str = "emotivo") -> dict[str, Any]:
        ...
        return self._armar_post(
            f"Reel: {tema}", "reel_hook_corto", "", tono,
            caption_text, hashtags)

    # ============== POSTS DE CONSTRUCCION ==============

    def post_presupuesto_obra(self, zona: str = "Cañuelas",
        ...
        caption_text = self.caption("presupuesto_obra", tono,
                                    zona=zona, metros_cuadrados=metros_cuadrados,
        ...
        return self._armar_post(
            f"Presupuesto en {zona}", "presupuesto_obra", zona, tono,
            caption_text, hashtags)

    def post_etapas_obra(self, metros_cuadrados: int = 120,
        n_etapas: int = 8,
        ...
        plazo_total: str = "8",
        tono: str = "educativo") -> dict[str, Any]:
        """Post sobre las 8 etapas de una obra."""
        caption_text = self.caption("etapas_obra", tono,
                                    metros_cuadrados=metros_cuadrados,
                                    n_etapas=n_etapas, etapa_1=etapa_1,
                                    etapa_2=etapa_2, etapa_3=etapa_3,
                                    etapa_4=etapa_4, etapa_5=etapa_5,
                                    etapa_6=etapa_6, etapa_7=etapa_7,
    ...
    def post_steel_frame_vs_tradicional(self, tono: str = "educativo") -> dict[str, Any]:
        ...
        return self._armar_post(
            "Steel Frame vs Tradicional", "steel_frame_vs_tradicional", "",
            tono, caption_text, hashtags)

    def post_planos_render(self, meses: int = 8,
        metros_cuadrados: int = 120,
        estilo: str = "moderna minimalista",
        tono: str = "aspiracional") -> dict[str, Any]:
        """Mockup planos vs realidad."""
        caption_text = self.caption("planos_render", tono,
                                    meses=meses)
        hashtags = self.hashtags(["arquitectura", "casas"])
        return self._armar_post(
            f"Planos vs Realidad ({estilo})", "planos_render", "", tono,
            caption_text, hashtags)

    def post_aberturas_instalaciones(self,
        puntos_electricos: int = 35,
        puntos_sanitarios: int = 8,
        tipo_termotanque: str = "solar",
        tono: str = "educativo") -> dict[str, Any]:
        """Detalles tecnicos de instalaciones."""
        caption_text = self.caption("aberturas_instalaciones", tono,
                                    puntos_electricos=puntos_electricos,
                                    puntos_sanitarios=puntos_sanitarios,
                                    tipo_termotanque=tipo_termotanque)
        hashtags = self.hashtags(["construccion", "ingenieria"])
        return self._armar_post(
            "Instalaciones y aberturas", "aberturas_instalaciones", "",
            tono, caption_text, hashtags)

    def post_pisos_revestimientos(self,
        ...
        caption_text = self.caption("pisos_revestimientos", tono,
                                    opcion_1=opcion_1, costo_1=costo_1,
                                    opcion_2=opcion_2, costo_2=costo_2,
                                    opcion_3=opcion_3, costo_3=costo_3)
        hashtags = self.hashtags(["decoracion", "diseno_interior", "casas"])
        return self._armar_post(
            "Pisos y revestimientos", "pisos_revestimientos", "",
            tono, caption_text, hashtags)

    def post_obra_terminada_entrega(self, cliente: str = "Familia Pérez",
        meses: int = 9,
        metros_cuadrados: int = 130,
        tiempo_total: str = "9 meses",
        nombre_obra: str = "Casa Pérez",
        etapa_cumplida: str = "Entrega de llaves",
        tono: str = "emotivo") -> dict[str, Any]:
        """Hito de entrega de obra."""
        caption_text = self.caption("obra_terminada_entrega", tono,
                                    cliente=cliente, meses=meses,
                                    metros_cuadrados=metros_cuadrados,
        ...
        hashtags = self.hashtags(["construccion", "casas", "general"])
        return self._armar_post(
            f"Entrega {nombre_obra}", "obra_terminada_entrega", "", tono,
            caption_text, hashtags)

    def post_plazo_construccion(self, metros_cuadrados: int = 120,
        plantas: int = 1,
        ...
        caption_text = self.caption("plazo_construccion", tono,
                                    metros_cuadrados=metros_cuadrados,
                                    plantas=plantas,
        ...
        return self._armar_post(
            "Plazos de construcción", "plazo_construccion", "", tono,
            caption_text, hashtags)
    ...
    def post_garantia_postventa(self, tono: str = "profesional") -> dict[str, Any]:
        ...
        hashtags = self.hashtags(["construccion", "casas"])
        return self._armar_post(
            "Garantía postventa", "garantia_postventa", "", tono,
            caption_text, hashtags)

    def post_materiales_premium(self,
        ...
        caption_text = self.caption("materiales_premium", tono,
                                    tipo_ladrillo=tipo_ladrillo,
                                    tipo_cable=tipo_cable,
                                    tipo_cañeria=tipo_cañeria)
        hashtags = self.hashtags(["construccion", "ingenieria"])
        return self._armar_post(
            "Materiales premium", "materiales_premium", "", tono,
            caption_text, hashtags)

    def post_errores_comunes_construccion(self,
        tono: str = "educativo") -> dict[str, Any]:
        """Errores frecuentes al construir."""
        caption_text = self.caption("errores_comunes_construccion", tono)
        hashtags = self.hashtags(["construccion", "casas"])
        return self._armar_post(
            "Errores comunes", "errores_comunes_construccion", "", tono,
            caption_text, hashtags)

    def post_equipo_trabajo_maquinaria(self, zona: str = "Cañuelas",
        n_excavadoras: int = 2,
        marca: str = "Komatsu",
        n_bulldozers: int = 1,
        n_camiones: int = 3,
        ...
        caption_text = self.caption("equipo_trabajo_maquinaria", tono,
                                    zona=zona,
                                    n_excavadoras=n_excavadoras, marca=marca,
        ...
        return self._armar_post(
            ...
            "equipo_trabajo_maquinaria", zona, tono,
            caption_text, hashtags)

    def post_permisos_tramites(self, zona: str = "Cañuelas",
        plazo_min: str = "2",
        plazo_max: str = "6",
        tono: str = "practico") -> dict[str, Any]:
        """Tramites municipales para construir."""
        caption_text = self.caption("permisos_tramites", tono,
                                    zona=zona,
                                    plazo_min=plazo_min, plazo_max=plazo_max)
        hashtags = self.hashtags(["permisos", "construccion", "general"], zona)
        return self._armar_post(
            f"Trámites en {zona}", "permisos_tramites", zona, tono,
            caption_text, hashtags)
    ...
    def post_diseno_interior_acabados(self, tono: str = "aspiracional") -> dict[str, Any]:
        ...
        return self._armar_post(
            "Diseño de interiores", "diseno_interior_acabados", "", tono,
            caption_text, hashtags)

    def _armar_post(self, tema: str, tipo: str, municipio: str,
                    tono: str, caption_text: str,
...
class RealestateStudio:
    ...
    def guardar_prompt(self, req: GenerationRequest, nombre: str,
        subcarpeta: str = "outputs") -> Path:
    ...
    def guardar_post(self, post: dict[str, Any], nombre: str,
...
def demo() -> None:
    ...
    ruta_post = studio.guardar_post(post, "venta_chacra_canuelas",
