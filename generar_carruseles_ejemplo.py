...
def main() -> None:
    ...
    c4 = factory.servicios(empresa="Construcciones Pampeanas", municipio="Cañuelas", n_slides=6)
    r4 = factory.guardar(c4, "servicios", proyecto=PROYECTO, vertical="servicios")
    print(f"[4/4] servicios: {c4.n_slides} slides -> {r4.relative_to(ROOT)}")

    print()
    print(f"Total: 4 carruseles · {c1.n_slides + c2.n_slides + c3.n_slides + c4.n_slides} slides")
